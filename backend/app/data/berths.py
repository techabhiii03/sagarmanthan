...
BERTHS: List[Dict[str, Any]] = [
    ...
    {
        "berth_key": "New Coal Import Berth (Paradip)",
        "display_name": "New Coal Import Berth",
        "port": "Paradip",
        "max_draft_m": 16.5,
        "max_loa_m": 300.0,
        "max_beam_m": 45.0,
        ...
        "notes": "Prototype planning limits for a Paradip coal-import berth. Panamax suitable; production limits require verification.",
    },
    {
